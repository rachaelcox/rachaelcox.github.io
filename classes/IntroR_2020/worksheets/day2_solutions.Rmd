...
Now, do the same plot but facet by species instead of coloring using `facet_wrap()`.
...
Using the `biopsy` dataset, make side-by-side boxplots of `clump for the three species of iris. The geom you need to use is `geom_boxplot()`.
