...
* Slides (R basics): [day1.pdf](/classes/IntroR_2020/slides/day1.pdf)
* Slides (Tidyverse intro): [tidy_intro.pdf](/classes/IntroR_2020/slides/tidy_intro.pdf)
...
* In-class worksheet 1 (R basics):
    - [R Markdown](/classes/IntroR_2020/worksheets/day1.Rmd)
    - [HTML](/classes/IntroR_2020/worksheets/day1.html)
    - [HTML, Solutions](/classes/IntroR_2020/worksheets/day1_solutions.html)
    - [Test dataset](/classes/datasets/mushrooms_small.csv)
* In-class worksheet 2 (Tidying data):
    - [R Markdown](/classes/IntroR_2020/worksheets/tidying.Rmd)
    - [HTML](/classes/IntroR_2020/worksheets/tidying.html)
    - [HTML, Solutions](/classes/IntroR_2020/worksheets/tidying_solutions.html)

### Day 2: Data visualization with ggplot2
* Slides: [day2.pdf](/classes/IntroR_2020/slides/day2.pdf)
...
* In-class worksheet:
    - [R Markdown](/classes/IntroR_2020/worksheets/day2.Rmd)
    - [HTML](/classes/IntroR_2020/worksheets/day2.html)
    - [HTML, Solutions](/classes/IntroR_2020/worksheets/day2_solutions.html)

### Day 3: Data transformation with dplyr
* Slides: [day3.pdf](/classes/IntroR_2020/slides/day3.pdf)
...
* In-class worksheet:
    - [R Markdown](/classes/IntroR_2020/worksheets/day3.Rmd)
    - [HTML](/classes/IntroR_2020/worksheets/day3.html)
    - [HTML, Solutions](/classes/IntroR_2020/worksheets/day3_solutions.html)

### Day 4: Specialized packages for bioanalysis in R
* Slides: [day4.pdf](/classes/IntroR_2020/slides/day4.pdf)
* Code along resources:
    - [DESeq2.rmd](/classes/IntroR_2020/worksheets/DESeq_demo.Rmd)
    - [Kallisto folder](/classes/datasets/kallisto_results.zip)
    - [dada2.rmd](/classes/IntroR_2020/worksheets/dada2_demo.Rmd)
...
* In-class worksheet:
    - [R Markdown](/classes/IntroR_2020/worksheets/day4.Rmd)
    - [HTML](/classes/IntroR_2020/worksheets/day4.html)
    - [HTML, Solutions](/classes/IntroR_2020/worksheets/day4_solutions.html)
